...
function image_to_graph(cv, max_x, max_y)
...
function processing(;image_name::String="ISIC_0024943.jpg", directory::String="datasets\\HAM10000\\HAM10000_images" )
    gr()
    ...
    img = image_to_graph(cv, max_x, max_y)
    ...
    cropped_image = crop(image, cluster_boundries, original_size, minimum_size=MINIMUM_SIZE, border=(10, 10))
